...
Author: Piano Hagens
html tag: .wrapper Page->#sliders-> .container page->.mySlider .control prev .control next
*/
...
var Swiper = function(selector, options) {
	...
	touchStart = function(e) {
		...
		// Get start point
		swipe.startX = e.touches ? e.touches[0].mySliderX : e.mySliderX;
		swipe.startY = e.touches ? e.touches[0].mySliderY : e.mySliderY;
	...
	touchMove = function(e) {
		if ( !$parent.hasClass('disabled') ) {
			swipe.started = true;
			var touchX = e.touches ? e.touches[0].mySliderX : e.mySliderX,
				touchY = e.touches ? e.touches[0].mySliderY : e.mySliderY,
